...
def makelist_parallel(sigmaarea_function,inputslist,workers=cpus/2):
    """
    Inputs:
    ...
    sigmaarealist = Parallel(n_jobs=int(workers))(delayed(sigmaarea_function)(inputinstance) for inputinstance in inputslist)
