...
def main():
    ...
    initialpointsInstance.extendedZoneMultiply(2)
    ...
    orbitsinstance.createOrbits(B,termination_resolution=0.1,mult_factor=15,sampletimes= np.linspace(0,0.5,10000))
